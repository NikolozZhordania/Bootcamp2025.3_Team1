...
public class QRCodeNavigationTest extends BaseTest {
    ...
    @Test(description = "SCRUM-T9 Step 2: Navigate to TBC Cards and click take card button",
            priority = 2,
    ...
    @Test(description = "SCRUM-T9 Step 3: Verify QR code and navigate to QR URL",
            priority = 3,
